...
export default class QTurnos extends Component {
    ...
    async componentDidMount() {
        ...
        const url = "https://"+domain+"/smartcenter/qturnos?usuario="+usuario;
        const response = await fetch(url);
        const data = await response.json();
        const tur = await data[0];
